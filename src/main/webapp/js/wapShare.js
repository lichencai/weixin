 ...
 var fJson = {
    ...
    'sinaT' : function(){
        (function(){window.open('http://v.t.sina.com.cn/share/share.php?title='+encodeURIComponent(document.title)+'&url='+encodeURIComponent(location.href)+'&source=bookmark','_blank','width=450,height=400');})()
      },
		'renren':function(){
			   (function(){window.open('http://widget.renren.com/dialog/share?resourceUrl='+encodeURIComponent(location.href)+'&srcUrl='+encodeURIComponent(location.href)+'&title='+encodeURIComponent(document.title)+'&description='+encodeURIComponent(document.title),'_blank','width=450,height=400');})()
		},
    'douban':function(){
       (function(){window.open('http://www.douban.com/share/service?href='+encodeURIComponent(location.href)+'&name='+encodeURIComponent(document.title)+'&text='+encodeURIComponent(document.title),'_blank','width=450,height=400');})()
    },
    'weixin' : function(){
